...
Objetivo inmutable de la remediación: tag `v0.21.25-B20-completed-r3`, ZIP `FS_v0.21.25_B20_completed_r3.zip` y sidecar `FS_v0.21.25_B20_completed_r3.zip.sha256`. Es candidato no promovible hasta completar todos los gates y no altera la pareja activa de Fuentes.
