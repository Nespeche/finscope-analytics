...
try {
  ...
  check('B20_CLOSURE_R4_HANDOFF_IDENTITY', handoff.release?.releaseRevision === 'v0.21.25_B20_completed_r4' && handoff.release?.tag === 'v0.21.25-B20-completed-r4' && handoff.release?.zipName === 'FS_v0.21.25_B20_completed_r4.zip' && handoff.release?.sidecarName === 'FS_v0.21.25_B20_completed_r4.zip.sha256', JSON.stringify(handoff.release));
  check('B20_CLOSURE_R4_STATE_IDENTITY', state.activePackageLogicalName === 'FS_v0.21.25_B20_completed_r4.zip', state.activePackageLogicalName);
  check('B20_CLOSURE_R4_METADATA_IDENTITY', metadata.releaseRevision === 'v0.21.25_B20_completed_r4' && metadata.logicalZipName === 'FS_v0.21.25_B20_completed_r4.zip' && metadata.finalSha256Sidecar === 'FS_v0.21.25_B20_completed_r4.zip.sha256', JSON.stringify({ releaseRevision: metadata.releaseRevision, logicalZipName: metadata.logicalZipName }));
