...
FinScope Analytics es una SPA Svelte 5 determinista y local-first para análisis fundamental. El baseline normativo activo continúa siendo `FS_v0.21.25_B20_completed.zip`, SHA-256 `c18b1390c416b5c538e1b7cf704c610754e4cff2f3eeec8c2c08bc800b120fc6`, hasta que exista un nuevo Release completed reautenticado y el usuario sustituya expresamente la pareja de Fuentes. La remediación apunta a la identidad nueva `v0.21.25-B20-completed-r3` / `FS_v0.21.25_B20_completed_r3.zip`; no reemplaza ni muta el Release completed vigente.
